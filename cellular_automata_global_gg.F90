module cellular_automata_global_gg_mod
...
subroutine cellular_automata_global_gg(kstep,restart,first_time_step,ca1_cpl,ca2_cpl,ca3_cpl, &
...
end subroutine cellular_automata_global_gg

end module cellular_automata_global_gg_mod
